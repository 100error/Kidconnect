        ...
        items: [
          {
            ...
            icon: "people",
            example: "My best friend plays with me.",
          },
          {
            id: "iv2",
            word: "People",
            soundsLike: "peepul",
            spelling: "p-e-o-p-l-e",
            icon: "people-circle",
        ...
        items: [
          {
            ...
            icon: "calendar",
            example: "We go to the park on Wednesday.",
          },
          {
            id: "sl2",
            word: "Receipt",
            ...
            icon: "receipt",
            example: "Dad got a receipt from the store.",
          },
          {
            id: "sl3",
            word: "Biscuit",
          ...
          },
          {
            ...
            icon: "map",
            example: "The island is in the ocean.",
          },
          {
            id: "sl5",
            word: "Muscle",
          ...
          },
          {
            ...
            spelling: "k-n-i-f-e",
            icon: "restaurant",
            example: "Use a knife to cut the apple.",
          },
          {
            id: "sl8",
            word: "Hour",
          ...
          },
          {
            ...
            spelling: "g-h-o-s-t",
            icon: "skull",
            example: "The ghost said boo!",
          },
          {
            id: "sl10",
            word: "Answer",
            soundsLike: "anser",
            spelling: "a-n-s-w-e-r",
            icon: "chatbox",
        ...
        items: [
          {
            ...
            icon: "medal",
            example: "The colonel leads the soldiers.",
          },
          {
            id: "ss2",
            word: "Through",
            ...
            icon: "arrow-forward",
            example: "We walked through the door.",
          },
          {
            id: "ss3",
            word: "Enough",
          ...
          },
          {
            ...
            spelling: "r-o-u-g-h",
            icon: "thumbs-down",
            example: "The dog's fur is rough.",
          },
          {
            id: "ss5",
            word: "Tough",
            ...
            spelling: "t-o-u-g-h",
            icon: "barbell",
            example: "The meat was tough to chew.",
          },
          {
            id: "ss6",
            word: "Cough",
          ...
          },
          {
            ...
            spelling: "c-h-o-i-r",
            icon: "musical-notes",
            example: "The choir sings beautifully.",
          },
          {
            id: "ss9",
            word: "Queue",
            ...
            spelling: "q-u-e-u-e",
            icon: "people",
            example: "Stand in the queue for tickets.",
          },
          {
            id: "ss10",
            word: "Yacht",
            ...
            spelling: "y-a-c-h-t",
            icon: "boat",
            example: "The yacht sailed on the sea.",
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            spelling: "b-r-o-k-e",
            icon: "hammer",
            example: "He broke his toy.",
          },
          {
            id: "iv_a5",
            word: "Bring (Brought)",
            soundsLike: "brawt",
            spelling: "b-r-o-u-g-h-t",
            icon: "basket",
            example: "She brought a cake.",
          },
          {
            id: "iv_a6",
            word: "Buy (Bought)",
            soundsLike: "bawt",
            spelling: "b-o-u-g-h-t",
            icon: "cart",
            example: "Mom bought some milk.",
          },
          {
            id: "iv_a7",
            word: "Catch (Caught)",
            soundsLike: "kawt",
            spelling: "c-a-u-g-h-t",
            icon: "hand-left",
          ...
          },
          {
            ...
            spelling: "a-t-e",
            icon: "fast-food",
            example: "We ate pizza for lunch.",
          },
          {
            id: "iv_a15",
            word: "Fall (Fell)",
        ...
        items: [
          {
            ...
            spelling: "t-o-o-k",
            icon: "hand-right",
            example: "She took a cookie.",
          },
          {
            id: "iv_c2",
            word: "Teach (Taught)",
            soundsLike: "tawt",
            spelling: "t-a-u-g-h-t",
            icon: "school",
            example: "The teacher taught us math.",
          },
          {
            id: "iv_c3",
            word: "Tell (Told)",
          ...
          },
          {
            ...
            soundsLike: "un-der-stood",
            spelling: "u-n-d-e-r-s-t-o-o-d",
            icon: "happy",
            example: "She understood the lesson.",
          },
          {
            id: "iv_c6",
            word: "Wear (Wore)",
                ...
                >
                  <View style={styles.cardHeader}>
                    ...
                    <View style={styles.wordContainer}>
                      ...
                      <Text style={styles.soundsLikeText}>
                        Sounds like: {item.soundsLike}
                      </Text>
                    </View>
                    <Ionicons
                      name={
                        playingId === item.id ? "stop-circle" : "volume-high"
                      }
                      size={28}
                      color={group.darkColor}
                    />

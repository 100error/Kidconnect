    ...
    options: [
      {
        id: "1a",
        word: "Apple",
        image: require("@/assets/oddwordout/apple.png"),
        isOdd: false,
      },
      {
        id: "1b",
        word: "Banana",
        image: require("@/assets/oddwordout/banana.png"),
        isOdd: false,
      },
      {
        id: "1c",
        word: "Grapes",
        image: require("@/assets/oddwordout/grapes.png"),
        isOdd: false,
      },
      {
        id: "1d",
        word: "Carrot",
        image: require("@/assets/oddwordout/carrot.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "2a",
        word: "Cat",
        image: require("@/assets/oddwordout/cat.png"),
        isOdd: false,
      },
      {
        id: "2b",
        word: "Dog",
        image: require("@/assets/oddwordout/dog.png"),
        isOdd: false,
      },
      {
        id: "2c",
        word: "Cow",
        image: require("@/assets/oddwordout/cow.png"),
        isOdd: false,
      },
      {
        id: "2d",
        word: "Bus",
        image: require("@/assets/oddwordout/bus.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "3a",
        word: "Red",
        image: require("@/assets/oddwordout/red.png"),
        isOdd: false,
      },
      {
        id: "3b",
        word: "Blue",
        image: require("@/assets/oddwordout/blue.png"),
        isOdd: false,
      },
      {
        id: "3c",
        word: "Green",
        image: require("@/assets/oddwordout/green.png"),
        isOdd: false,
      },
      {
        id: "3d",
        word: "Chair",
        image: require("@/assets/oddwordout/chair.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "4a",
        word: "One",
        image: require("@/assets/oddwordout/one.png"),
        isOdd: false,
      },
      {
        id: "4b",
        word: "Two",
        image: require("@/assets/oddwordout/two.png"),
        isOdd: false,
      },
      {
        id: "4c",
        word: "Three",
        image: require("@/assets/oddwordout/3.png"),
        isOdd: false,
      },
      {
        id: "4d",
        word: "A",
        image: require("@/assets/oddwordout/alphabet.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "5a",
        word: "Eyes",
        image: require("@/assets/oddwordout/eyes.png"),
        isOdd: false,
      },
      {
        id: "5b",
        word: "Ear",
        image: require("@/assets/oddwordout/ear.png"),
        isOdd: false,
      },
      {
        id: "5c",
        word: "Nose",
        image: require("@/assets/oddwordout/nose.png"),
        isOdd: false,
      },
      {
        id: "5d",
        word: "Shirt",
        image: require("@/assets/oddwordout/shirt.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "6a",
        word: "Circle",
        image: require("@/assets/oddwordout/circle.png"),
        isOdd: false,
      },
      {
        id: "6b",
        word: "Square",
        image: require("@/assets/oddwordout/square.png"),
        isOdd: false,
      },
      {
        id: "6c",
        word: "Triangle",
        image: require("@/assets/oddwordout/triangle.png"),
        isOdd: false,
      },
      {
        id: "6d",
        word: "Pizza",
        image: require("@/assets/oddwordout/pizza.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "7a",
        word: "Sun",
        image: require("@/assets/oddwordout/sun.png"),
        isOdd: false,
      },
      {
        id: "7b",
        word: "Rain",
        image: require("@/assets/oddwordout/rain.png"),
        isOdd: false,
      },
      {
        id: "7c",
        word: "Snow",
        image: require("@/assets/oddwordout/snow.png"),
        isOdd: false,
      },
      {
        id: "7d",
        word: "Pig",
        image: require("@/assets/oddwordout/pig.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "8a",
        word: "Pen",
        image: require("@/assets/oddwordout/pen.png"),
        isOdd: false,
      },
      {
        id: "8b",
        word: "Book",
        image: require("@/assets/oddwordout/book.png"),
        isOdd: false,
      },
      {
        id: "8c",
        word: "Desk",
        image: require("@/assets/oddwordout/desk.png"),
        isOdd: false,
      },
      {
        id: "8d",
        word: "Ball",
        image: require("@/assets/oddwordout/ball.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "9a",
        word: "Bed",
        image: require("@/assets/oddwordout/bed.png"),
        isOdd: false,
      },
      {
        id: "9b",
        word: "Lamp",
        image: require("@/assets/oddwordout/lamp.png"),
        isOdd: false,
      },
      {
        id: "9c",
        word: "Sofa",
        image: require("@/assets/oddwordout/sofa.png"),
        isOdd: false,
      },
      {
        id: "9d",
        word: "Tree",
        image: require("@/assets/oddwordout/tree.png"),
        isOdd: true,
      },
    ],
  },
    ...
    options: [
      {
        id: "10a",
        word: "Water",
        image: require("@/assets/oddwordout/water.png"),
        isOdd: false,
      },
      {
        id: "10b",
        word: "Milk",
        image: require("@/assets/oddwordout/milk.png"),
        isOdd: false,
      },
      {
        id: "10c",
        word: "Juice",
        image: require("@/assets/oddwordout/juice.png"),
        isOdd: false,
      },
      {
        id: "10d",
        word: "Breads",
        image: require("@/assets/oddwordout/breads.png"),
        isOdd: true,
      },
    ],
  },
...
export default function OddWordOutScreen() {
  ...
  const optionWidth =
    (width - totalPadding - gap * (numColumns - 1)) / numColumns;
  ...
  const handlePronunciationCheck = (result: {
    transcript: string;
    confidence: number;
  }) => {
    if (!selectedOption) return;
    ...
    const pronouncedCorrectly = speechService.checkSpeechAccuracy(
      result,
      target,
    );
  ...
  const handleCorrectAnswer = () => {
    ...
    setTimeout(() => {
      if (currentQIndex < TOTAL_QUESTIONS - 1) {
        ...
        setFeedbackMessage("Find the odd word!");
        setFeedbackType("neutral");
      } else {
        finishGame();
      }

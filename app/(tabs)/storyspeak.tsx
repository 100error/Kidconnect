...
function StorySpeak() {
    ...
    () => [
      {
        ...
        target: "cat",
        image: require("@/assets/storyspeak/cat.png"),
      },
      {
        text: "I see a big dog.",
        target: "dog",
        image: require("@/assets/storyspeak/bigdog.png"),
      },
      {
        text: "She likes to play.",
        target: "play",
        image: require("@/assets/storyspeak/girlplaying.png"),
      },
      {
        text: "The sun is hot.",
        target: "sun",
        image: require("@/assets/storyspeak/hotsun.png"),
      },
      {
        text: "We go to the park.",
        target: "park",
        image: require("@/assets/storyspeak/playpark.png"),
      },
      {
        text: "The bird can fly.",
        target: "bird",
        image: require("@/assets/storyspeak/bird.png"),
      },
      {
        text: "I like red apples.",
        target: "apples",
        image: require("@/assets/storyspeak/redapple.png"),
      },
      {
        text: "My fish can swim.",
        target: "fish",
        image: require("@/assets/storyspeak/fish.png"),
      },
      {
        text: "The car is fast.",
        target: "car",
        image: require("@/assets/storyspeak/racing.png"),
      },
      {
        text: "I have a blue ball.",
        target: "ball",
        image: require("@/assets/storyspeak/blueball.png"),
      },
      {
        text: "The boy runs fast.",
        target: "boy",
        image: require("@/assets/storyspeak/run.png"),
      },
      {
        text: "The girl reads a book.",
        target: "book",
        image: require("@/assets/storyspeak/book.png"),
      },
      {
        text: "The cow gives milk.",
        target: "cow",
        image: require("@/assets/storyspeak/cow.png"),
      },
      {
        text: "The frog can jump.",
        target: "frog",
        image: require("@/assets/storyspeak/frog.png"),
      },
      {
        text: "The baby drinks milk.",
        target: "baby",
        image: require("@/assets/storyspeak/baby.png"),
      },
      {
        text: "The duck swims in water.",
        target: "duck",
        image: require("@/assets/storyspeak/duck.png"),
      },
      {
        text: "The monkey climbs a tree.",
        target: "monkey",
        image: require("@/assets/storyspeak/monkey.png"),
      },
      {
        text: "The train goes fast.",
        target: "train",
        image: require("@/assets/storyspeak/train.png"),
      },
      {
        text: "The kite flies high.",
        target: "kite",
        image: require("@/assets/storyspeak/kite.png"),
      },
      {
        text: "The flower smells nice.",
        target: "flower",
        image: require("@/assets/storyspeak/flower.png"),
      },
    ],
    [],
  );
  ...
  const handleSpeechResult = async (result: {
    ...
    if (speechService.checkSpeechAccuracy(result, currentStory.target)) {
      ...
      setTimeout(() => {
        Alert.alert("❌ Try Again", `Can you say “${currentStory.target}”?`, [
          {
            text: "Try Again",
            onPress: () => {
              Speech.stop();
  ...
  const renderStoryText = () => {
    const parts = currentStory.text.split(
      new RegExp(`(${currentStory.target})`, "gi"),
    );
    return (
        ...
        <View style={styles.mainContainer}>
          {!gameCompleted ? (
            <View style={[styles.card, { flexDirection: "column" }]}>
              ...
              <View style={styles.sentenceContainer}>{renderStoryText()}</View>
            ...
            <View style={[styles.card, styles.centerContent]}>
              <Text style={[styles.congrats, { fontSize: titleSize }]}>
                🎉 Awesome Job!
              </Text>
